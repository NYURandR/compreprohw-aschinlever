...
Wilson et al. describe several best practices for computational reproducibility. One of the most important practices they suggest is by keeping track of changes and describing the changes made. This can be accomplished by using R and maintaining a github repository. This allows multiple collaborators to see the version history. 
